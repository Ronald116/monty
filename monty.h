...
int execute(char *content, stack_t **head, unsigned int data, FILE *file);
...
void mod(stack_t **head, unsigned int data);
...
void rotr(stack_t **head, __attribute__((unused)) unsigned int data);
void addNode(stack_t **head, int n);
void addQueue(stack_t **head, int n);
void queue(stack_t **head, unsigned int data);
void stack(stack_t **head, unsigned int data);
#endif
